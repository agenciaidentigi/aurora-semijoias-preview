insert into profiles (id, email, full_name, password_hash, role, is_active)
values (
...
insert into products (name, slug, sku, short_description, description, current_price, old_price, installments, discount_percent, category_id, material, plating, stone, color, main_image_url, badge, is_featured, is_new, is_promo, display_order, original_url, affiliate_partner_id, estimated_commission, seo_title, seo_description, status)
select 'Anel solitario zirconia cristal', 'anel-solitario-zirconia-cristal', 'AUR-001', 'Anel delicado com ponto de luz.', 'Semijoia de acabamento polido para uso diario e presente.', 89.90, 109.90, '3x de R$ 29,97', 18, cat.id, 'Liga metalica', 'Ouro 18k', 'Zirconia', 'Dourado', 'https://images.unsplash.com/photo-1603561596112-0a132b757442?auto=format&fit=crop&w=900&q=85', 'Destaque', true, true, false, 1, 'https://loja-demo.com/produto/anel-solitario-zirconia-cristal', partner.id, 7.64, 'Anel solitario zirconia cristal', 'Anel solitario banhado a ouro com link de afiliado.', 'published'
from partner, cat
on conflict (slug) do nothing;
...
('site', '{"name":"Aurora Semijoias","instagram":"https://instagram.com/","affiliateDisclosure":"Compras sao realizadas em lojas parceiras."}', 'Configuracoes gerais da loja')
